...
parser.add_argument('--nThreads', type=int, default=1, help='number of threads to use in data loader')
...
data_loader = dl.CreateDataLoader(opt.datasets,dataset_mode=opt.dataset_mode, load_size=opt.load_size, batch_size=opt.batch_size, serial_batches=False, nThreads=opt.nThreads)
...
if opt.dataset_mode == 'tnn':
    data_loader_val = dl.CreateDataLoader('val', dataset_mode=opt.dataset_mode, load_size=opt.load_size, batch_size=opt.batch_size, serial_batches=False, nThreads=opt.nThreads)
